...
public class ResponseUtils {
	 ...
	 * 无权限的code返回码
	 */
	public static int ERROR_NOPERMS_CODE = 800;
	 ...
	 * @return
	 */
	private static HashMap<String, Object> toResponseObject(int code, List list) {
		HashMap<String, Object> reMap = new HashMap<String, Object>();
		reMap.put("code", code);
		reMap.put("msg", list);
		return reMap;
	 ...
	 * @return
	 */
	public static HashMap<String, Object> success(Object o) {
		return toResponseObject(SUCCESS_CODE, o);
	}
	 ...
	 * @return
	 */
	private static HashMap<String, Object> toResponseObject(int code, Object o) {
		HashMap<String, Object> reMap = new HashMap<String, Object>();
		reMap.put("code", code);
		reMap.put("msg", o);
		return reMap;
