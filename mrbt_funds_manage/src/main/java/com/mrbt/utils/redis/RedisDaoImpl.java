...
public class RedisDaoImpl implements RedisDao {
	...
	private JdkSerializationRedisSerializer getSerial() {
		return (JdkSerializationRedisSerializer) redisTemplate
				.getValueSerializer();
	}
	...
	public boolean deleteByScore(final String key, final double score) {
		return redisTemplate.execute(new RedisCallback<Object>() {
			...
			public String doInRedis(RedisConnection connection)
					throws DataAccessException {
				return connection.zRemRangeByScore(redisTemplate
						.getStringSerializer().serialize(key), score, score) > 0 ? "ok"
						: "fail";
			}
		}).equals("okay");
	}
	...
	@Override
	public List<Object> ZRANGE(final String key, final long start,
			final long end) {
		return redisTemplate.execute(new RedisCallback<List<Object>>() {
			...
			public List<Object> doInRedis(RedisConnection connection)
					throws DataAccessException {
				Set<byte[]> result = connection.zRange(redisTemplate
						.getStringSerializer().serialize(key), start, end);
	...
	@Override
	public List<Object> ZREVRANGE(final String key, final long start,
			final long end) {
		return redisTemplate.execute(new RedisCallback<List<Object>>() {
			...
			public List<Object> doInRedis(RedisConnection connection)
					throws DataAccessException {
				Set<byte[]> result = connection.zRevRange(redisTemplate
						.getStringSerializer().serialize(key), start, end);
				List<Object> reList = new ArrayList<Object>();
				for (byte[] tmp : result) {
					reList.add(getSerial().deserialize(tmp));
	...
	public Long ZREVRANK(final String key, final Object member) {
		return redisTemplate.execute(new RedisCallback<Long>() {
			...
			public Long doInRedis(RedisConnection connection)
					throws DataAccessException {
				return connection.zRevRank(redisTemplate.getStringSerializer()
						.serialize(key), getSerial().serialize(member));
			}
		});
	}
	...
	public Long ZRANK(final String key, final Object member) {
		return redisTemplate.execute(new RedisCallback<Long>() {
			...
			public Long doInRedis(RedisConnection connection)
					throws DataAccessException {
				return connection.zRank(
						redisTemplate.getStringSerializer().serialize(key),
						getSerial().serialize(member)).longValue();
			}
		});
	}

	@Override
	public List<Object> ZRANGE_BY_ZRANK(String key, Object member,
			long start_offset, long end_offset) {
		long index = ZRANK(key, member);
		return ZRANGE(key, index + start_offset < 0 ? 0 : index + start_offset,
				index + end_offset);
	}

	@Override
	public List<Object> Z_REV_RANGE_BY_ZRANK(String key, Object member,
			long start_offset, long end_offset) {
		long index = ZREVRANK(key, member);
		return ZREVRANGE(key, index + start_offset < 0 ? 0 : index
				+ start_offset, index + end_offset);
	}

	@Override
	public boolean ZREMRANGEBYSCORE(final String key, final long min,
			final long max) {
		return redisTemplate.execute(new RedisCallback<String>() {
			...
			public String doInRedis(RedisConnection connection)
					throws DataAccessException {
				connection.zRemRangeByScore(redisTemplate.getStringSerializer()
	...
	@Override
	public List<Object> ZRANGEBYSCORE(final String key, final long min,
			final long max) {
		return redisTemplate.execute(new RedisCallback<List<Object>>() {
			...
			public List<Object> doInRedis(RedisConnection connection)
					throws DataAccessException {
				Set<byte[]> result = connection.zRangeByScore(redisTemplate
						.getStringSerializer().serialize(key), min, max);
				List<Object> reList = new ArrayList<Object>();
				for (byte[] tmp : result) {
					reList.add(getSerial().deserialize(tmp));
				}
	...
	@Override
	public List<Object> ZREVRANGEBYSCORE(final String key, final long min,
			final long max) {
		return redisTemplate.execute(new RedisCallback<List<Object>>() {
			...
			public List<Object> doInRedis(RedisConnection connection)
					throws DataAccessException {
				Set<byte[]> result = connection.zRevRangeByScore(redisTemplate
						.getStringSerializer().serialize(key), min, max);
				List<Object> reList = new ArrayList<Object>();
				for (byte[] tmp : result) {
					reList.add(getSerial().deserialize(tmp));
	...
	@Override
	public boolean expire(String key, int timeout, TimeUnit timeUinit) {
		try {
