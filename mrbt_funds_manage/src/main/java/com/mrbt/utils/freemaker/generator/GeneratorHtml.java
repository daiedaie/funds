...
public class GeneratorHtml {
	...
	public static void main(String[] args) {
		// @todo 自己的一个类
		Map rootTest = new HashMap();
		rootTest.put("title", "12123123");
		rootTest.put("addtime", "22222222222");
		rootTest.put("showContent", null);
		// @todo 装入新闻
		...
		root.put("newsitem", rootTest);

		String sGeneFilePath = "d:/tpxw/";

		String sFileName = "1.htm";

		test.geneHtmlFile("test.ftl",
				"E:/project/mrbt/mrbt_oa/src/com/mrbt/utils/freemaker/ftl",
