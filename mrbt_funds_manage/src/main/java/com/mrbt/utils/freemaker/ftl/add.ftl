				 	...
				 	<tr>
	                        ...
	                        <td <#if index % 2!=0 && !column_has_next>colspan="3"</#if>>
	                        	...
	                        	<#if column.type?upper_case=="STRING">
	                        		<input  class="easyui-textbox" name="${column.name}" id="a${column.name}" style="width:200px" data-options="required:true"></input>
	                        	<#elseif column.type?upper_case=="DATE">
	                        		<input  class="easyui-datebox" name="${column.name}" id="a${column.name}" style="width:200px" data-options="required:true"></input>
	                        	<#elseif column.type?upper_case=="INT">
	                        		<input  class="easyui-numberbox" name="${column.name}" id="a${column.name}" style="width:200px" data-options="required:true"></input>
	                        	<#elseif column.type?upper_case=="TIME">
	                        		<input  class="easyui-datetimebox" name="${column.name}" id="a${column.name}" style="width:200px" data-options="required:true"></input>
	                        	<#elseif column.type?upper_case=="COMBOBOX">
	                        		<select class="easyui-combobox" name="${column.name}" id="a${column.name}" style="width: 200px" data-options="required:true">
