...
<head>
<meta charset="UTF-8">
<title>基金组合曲线下线日志</title>
<jsp:include page="/common/head.jsp"></jsp:include>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/js/funds/packageCurveLog/show.js"></script>
</head>
<body>
				...
				<table>
					...
					<tr>
						...
						<td><input class="easyui-datebox" style="width: 200px"
							id="createTime" name="createTime"></td>
						<th>操作方式：</th>
						<td><select class="easyui-combogrid" name="operateStyle"
							id="operateStyle" style="width: 200px"
							data-options="
							            idField: 'id',
							            editable:false,
							            loadMsg:'正在加载,请稍后...',
							            textField: 'name',
							            url: '/resource/json/operateStyle.json',
							            method: 'get',
							            columns: [[
