...
public class HttpClientUtil_Market_TEST {
	public static final Logger log = LogManager
			.getLogger(HttpClientUtil_Market_TEST.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String delete = post.delete(post);
	 ...
	 * 执行查询的索引
	 */
	public String select(HttpClientUtil_Market_TEST post) {
		String url = "http://localhost:8090/mrbt_funds_solrj/markettable/add";
	 ...
	 * @return
	 */
	public String delete(HttpClientUtil_Market_TEST post){
		String url = "http://localhost:8090/mrbt_funds_solrj/markettable/delete";
		Map<String,String> map = new HashMap<String, String>();
		map.put("funds_code", "123456");
		return post.doPost(url,map, "UTF-8");
	}

	/*
	 * 测试添加Market索引
	 */
	public void add(HttpClientUtil_Market_TEST post) {
